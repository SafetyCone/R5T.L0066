...
namespace R5T.L0066
{
    ...
    public partial interface IXmlTextOperator : IFunctionalityMarker
    {
        ...
        /// </summary>
        /// <remarks>
        /// The XML standard (<inheritdoc cref="Y0006.Documentation.For_Xml.Links.XmlStandardEndOfLineHandling" path="/summary"/>) specifies that all end-of-lines must be new lines ('\n').
